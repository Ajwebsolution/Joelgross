...
<div id="page-wrapper" data-scroll-easing="easeOutBack">
    ...
    <!-- Section - Double -->
    <section id="section03" class="wow fadeInUp section section-double left fullheight bg-green dark" data-header-change="true">
        ...
        <div class="col-md-6 content margin-b-50 wow fadeInRight">
            ...
            <?php 
                                        $online_anfrage = get_field('button'); 
                                            ?>
            <span data-target="local-scroll"><a href="<?php echo $online_anfrage['url'] ; ?>" target="_blank" class="btn btn-default"><span><?php echo $online_anfrage['title'] ; ?></span></a></span>
        </div>
    </section>
    <!-- Section - Double / End -->
          ...
          <?php
            ...
            <div class="masonry-item wow fadeInDown">
                <div class="gallery-item">
                    <div class="item-photo"><a href="<?php the_permalink(); ?>" ><img src="<?php the_post_thumbnail_url(); ?>" alt="" /></a></div>
                    <div class="item-hover bg-dark dark">
                        <div class="item-hover-content">
                            <h3><?php echo wp_trim_words(get_the_title(), 5); ?> <strong></strong> </h3>
							
                            <a href="<?php the_permalink(); ?>"  target="_blank" class="btn btn-orange" target><span>Referenzen anschauen</span></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row text-center">  
                ...
                <div class="col-sm-3 col-xs-6">
                    <div class="member-box margin-b-30">
                        <div class="member-photo margin-b-10"><img class="square" src="<?php echo $member_image ; ?>" alt="" /></div>
