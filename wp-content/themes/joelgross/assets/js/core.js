...
var Kwadrat = {
  ...
  Basic: {
    ...
    scroller: function () {
      ...
      $("#page-wrapper.padding-t-header").css(
        "padding-top",
      ...
      $section.waypoint({
        ...
        offset: function () {
          if ($header.hasClass("header-horizontal"))
            return -this.element.clientHeight + 66;
    ...
    verticalCenter: function () {
      var vCenter = function () {
        $(".v-center").each(function () {
          $(this).css({
            "margin-top":
              $(this).parent().height() / 2 - $(this).outerHeight() / 2 + "px",
          });
        });
      };
      vCenter();
      ...
      $contactForm.validate({
        ...
        messages: {
          name: {
            ...
            minlength: "Der Name sollte 2 Zeichen beinhalten.",
          },
          email: {
            required: "Bitte E-Mail Adresse angeben.",
            minlength: "Diese E-Mail Adresse ist nicht korrekt.",
          },
          message: {
            required: "Wie können wir Sie weiterhelfen? .",
            minlength: "Ihre Nachricht sollte mindestens 10 Zeichen erhalten. ",
          },
        },
      });
        ...
        if ($contactForm.valid()) {
          $.ajax({
            ...
            success: function (msg) {
              if (msg === "SEND") {
                response =
                  '<div class="alert alert-success">Vielen Dank für Ihre Nachricht, wir melden uns so schnell wie möglich bei Ihnen.';
              } else {
                response =
